        ...
        $('#dataAgendaPelatihanTable').DataTable({
            ...
            "columns": [
                ...
                },
                {
                    "data": null,
                    "render": function(data, type, row) {
                        let isDisabled = (row.status.toLowerCase() === 'selesai' || row.status.toLowerCase() === 'sedang berlangsung'|| row.status.toLowerCase() === 'pendaftaran berakhir' || row.status.toLowerCase() === 'masa pendaftaran');
